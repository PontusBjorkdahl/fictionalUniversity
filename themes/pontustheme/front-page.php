    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          ...
          <?php
            $today = date('Ymd');
            // Create a new instance (object) of the WP_Query class. This enables custom queries. 
            $homepageEvents = new WP_Query(array(
              // If posts_per_page value is set to -1 then it only return posts that has these values.
              'posts_per_page' => 2,
              'post_type' => 'event',
              'meta_key' => 'event_date',
              ...
              'order' => 'ASC',
              'meta_query' => array(
                // To prevent showing events (posts) that has dates older than today
                array(
                  'key' => 'event_date',
                  'compare' => '>=',
                  'value' => $today,
