...
class OurWordFilterPlugin {
    ...
    function ourMenu() {
        // You can also give a path to a image. Instead of 'data:image..' use plugin_dir_url(__FILE__) . 'custom.svg'
        $mainPageHook = add_menu_page(
                'Words To Filter', 'Word Filter', 
                'manage_options', 'ourwordfilter', 
        ...
        add_submenu_page(
            'ourwordfilter', 'Words To Filter', 
            'Words List', 'manage_options', 
            'ourwordfilter', array($this, 'wordFilterPage')
        );
        add_submenu_page(
            'ourwordfilter', 'Word Filter Options', 
    ...
    function wordFilterPage() { ?>
        <div class="wrap">
            ...
            <form method="POST">
                ...
                <label for="plugin_words_to_filter"><p>Enter a comma-seperated list of words to filter from yout site's content</p></label>
