...
class WordCountAndTimePlugin {
    ...
    function settings() {
        ...
        register_setting('wordcountplugin', 'wcp_location', array('sanatize_callback' => array($this, 'sanatize_location'), 'default' => '0'));

        add_settings_field('wcp_headline', 'Headline Text', array($this, 'headlineHTML'), 'word-count-settings-page', 'wcp_first_section');
        register_setting('wordcountplugin', 'wcp_headline', array('sanatize_callback' => 'sanitize_text_field', 'default' => 'Post Statistics'));

        add_settings_field('wcp_wordcount', 'Word Count', array($this, 'checkboxHTML'), 'word-count-settings-page', 'wcp_first_section', array('theName' => 'wcp_wordcount'));
        register_setting('wordcountplugin', 'wcp_wordcount', array('sanatize_callback' => 'sanitize_text_field', 'default' => '1'));
        ...
        register_setting('wordcountplugin', 'wcp_charactercount', array('sanatize_callback' => 'sanitize_text_field', 'default' => '1'));

        add_settings_field('wcp_readtime', 'Read Time', array($this, 'checkboxHTML'), 'word-count-settings-page', 'wcp_first_section', array('theName' => 'wcp_readtime'));
        register_setting('wordcountplugin', 'wcp_readtime', array('sanatize_callback' => 'sanitize_text_field', 'default' => '1'));
    }

    function sanatize_location($input) {
        if ($input != '0' && $input != '1') {
